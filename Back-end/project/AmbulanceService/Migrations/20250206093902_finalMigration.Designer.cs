...
namespace AmbulanceService.Migrations
{
    ...
    [Migration("20250206093902_finalMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AmbulanceService.Models.Booking", b =>
                {
                    b.HasOne("AmbulanceService.Models.Ambulance", "Ambulance")
                        .WithMany()
                        .HasForeignKey("AmbulanceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AmbulanceService.Model.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("AmbulanceService.Models.GuestUser", b =>
                {
                    b.HasOne("AmbulanceService.Models.Booking", "Booking")
                        .WithOne()
                        .HasForeignKey("AmbulanceService.Models.GuestUser", "BookingId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
